...
# Read
from numpy import *
csvFileName = "belonging_survey_2018-03-02.csv"
dataRaw = genfromtxt(csvFileName, delimiter=',')
...
# third parameter is the axis to delete along 
# black or none = flattened array, so the positions 
# 0 = X axis
# 1 = Y axis 
np.delete(dataClean, [1, 2, 3, 4, 5, 6, 7, 8, 9], 0)
